...
import InstructorStudentManagement from "./components/InstructorStudentManagement";
import InstructorSetting from "./components/InstructorsSetting";  
import InstructorEarnings from "./components/InstructorEarnings";
  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/instructor-student-management" element={<InstructorStudentManagement />} />
        <Route path="/instructor-setting" element={<InstructorSetting />} />
        <Route path="/instructor-earnings" element={<InstructorEarnings />} />
        <Route path="/instructor-ratings" element={<InstructorRatings />} />
