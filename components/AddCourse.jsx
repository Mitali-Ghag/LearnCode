...
const AddCourse = () => {
  ...
  const prepareFormData = (isPublished) => {
    ...
    courseDetails.lectures.forEach((lecture, index) => {
      ...
      formData.append(`lectures[${index}][video]`, lecture.video); // this must be a File object
    });
  ...
  return (
    <div className="add-course-container">
      ...
      {/* Course Form Continues Below... */}
      {/* You already have the form inputs after this point – you can paste in the remaining part starting from the JSX inside return */}
      ...
      {/* Access Type: Lifetime or Limited */}
      <div>
