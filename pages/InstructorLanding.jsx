...
import "../styles/InstructorLanding.css"; // External CSS file
    ...
    <div className="instructor-landing">
      ...
      <nav className="navbar">
        ...
        <ul className="nav-links">
          <li>Home</li>
          <li>
            <a href="#why-teach">Features</a>
          </li>
          <li>
            <Link to="/landing">Student</Link>
          </li>
          <li>
        ...
        <div className="auth-buttons">
          ...
          <Link to="/signup?role=instructor" className="signup-btn">
            Sign Up
          </Link>
        </div>
      </nav>
